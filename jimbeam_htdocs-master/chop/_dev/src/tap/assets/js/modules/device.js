...
const television = ['googletv', 'viera', 'smarttv', 'internet.tv', 'netcast', 'nettv', 'appletv', 'boxee', 'kylo', 'roku', 'dlnadoc', 'roku', 'pov_tv', 'hbbtv', 'ce-html'];
...
device.portrait = function () {
  if (Object.prototype.hasOwnProperty.call(window, 'onorientationchange') && window.screen.orientation) {
