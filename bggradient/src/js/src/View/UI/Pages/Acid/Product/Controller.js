...
export default class Controller extends Base {
  ...
  setup() {
    // canvaswrap
    this.wrap = document.querySelector(".js-acid__product-canvaswrap");
    this.w = gb.productWrapW = this.wrap.getBoundingClientRect().width;
    this.h = gb.productWrapH = this.wrap.getBoundingClientRect().height;
