...
import fs1 from './shader1.fs';
import fs2 from './shader2.fs';
import fs3 from './shader3.fs';
import fs4 from './shader4.fs';
import fs5 from './shader5.fs';
import fs6 from './shader6.fs';
import fs7 from './shader7.fs';
import fs8 from './shader8.fs';
import fs9 from './shader9.fs';
import fs10 from './shader10.fs';
...
export default class Plane extends Base {
  ...
  setup() {
    ...
    log(this.fsIndex);
    this.fss = [fs1,fs2,fs3,fs4,fs5,fs6,fs7,fs8,fs9,fs10];
  ...
  ready() {
    ...
    var mat = new THREE.ShaderMaterial({vertexShader: vs,fragmentShader: this.fss[this.fsIndex],uniforms: this.uniforms,transparent: true,depthTest: true,side: THREE.DoubleSide});
    ...
    var mat = new THREE.ShaderMaterial({vertexShader: vs,fragmentShader: this.fss[this.fsIndex],uniforms: this.uniforms2,transparent: true,depthTest: true,side: THREE.DoubleSide});
