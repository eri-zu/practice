	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      // // ui
	      this.logo = new _Controller2.default();
	      if (gb.urlp.textpattern == '0') this.tit = new _Controller4.default();
	      if (gb.urlp.textpattern == '1') this.tit = new _Controller6.default();
	      if (gb.urlp.textpattern == '2') this.tit = new _Controller8.default();
	      // if (gb.urlp.textpattern=='0') this.tit = new Tit();
	      this.text = new _Controller10.default();
	      this.indicator = new _Controller12.default();
	      this.slider = new _Controller14.default();
	      this.underArrow = new _Controller16.default();
	      this.menu = new _Controller18.default();
	    ...
	    value: function timeline() {
	      ...
	      tl.add(function () {
	        ...
	        _this2.text.showFirst();
	      }, 2.0).add(function () {
	
	        _this2.indicator.show();
	        _this2.underArrow.show();
	        _this2.menu.b.b_o.show_o();
	      }, 3.3).add(function () {
	
	        _this2.indicator.timeline();
	      }, 4.3).add(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SetSpan = __webpack_require__(33);
	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      this.numList = [];
	      this.$num.each(function (index, el) {
	        var r = new _Render2.default($(el), index);
	        _this2.numList.push(r);
	      });
	      this.subList = [];
	      this.$sub.each(function (index, el) {
	        var r = new _Render2.default($(el), index);
	        _this2.subList.push(r);
	      });
	    ...
	    value: function show() {
	      ...
	      tl.add(function () {
	        ...
	        for (var i = 0; i < _this3.numList.length; i++) {
	          // var s = this.numList[i];
	          var s = _this3.numList[arr[i]];
	          s.show(i * 0.05);
	        }
	      }, 0.0).add(function () {
	
	        for (var i = 0; i < _this3.subList.length; i++) {
	          // var s = this.subList[i];
	          var s = _this3.subList[arr_s[i]];
	          s.show(i * 0.05);
	        }
	      }, 0.4).add(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UIController = function (_Base) {
	  ...
	  function UIController() {
	    ...
	    _this.$target = $('.slider .textWrap .textItem .tit');
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      this.$target.each(function (index, el) {
	        ...
	        var item = new _Item2.default($(el));
	    ...
	    value: function next() {
	      ...
	      tl.add(function () {
	        ...
	        _this3.hide(_this3.pre);
	      }, 0.0).add(function () {
	
	        _this3.show(_this3.index);
	      }, 0.0);
	    }
	  }, {
	    key: 'onResize',
	    ...
	    value: function setEvents() {
	      ...
	      $(window).on('sliderChange', function (e, index, pre) {
	
	        _this4.index = index;
	        _this4.pre = pre;
	        log(_this4.index, _this4.pre);
	        _this4.next();
	      });
	    }
	  }]);
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function show() {
	      ...
	      tl.add(function () {
	        ...
	        for (var i = 0; i < _this3.spanList.length; i++) {
	          var s = _this3.spanList[i];
	    ...
	    value: function hide() {
	      ...
	      tl.add(function () {
	        ...
	        for (var i = 0; i < _this4.spanList.length; i++) {
	          var s = _this4.spanList[i];
	          // var s = this.spanList[arr[i]];
	          s.hide(i * 0.05);
	        }
	      }, 0.0);
	...
	var SpanText = function () {
	  ...
	  _createClass(SpanText, [{
	    ...
	    value: function set($target) {
	      ...
	      // br追加して連結
	      var append = span.join('<br class="sp">');
	    ...
	    value: function hide(delay) {
	      ...
	      TweenMax.to(this.$span, .7, {
	        ...
	        onComplete: function onComplete() {
	          ...
	          _this3.rot = -45 * 3;
	          TweenMax.set(_this3.$span, { rotation: _this3.rot });
	        },
	        delay: delay
	      });
	    }
	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function show(delay) {
	      ...
	      TweenMax.set(this.$span, { x: 20, opacity: 0 });
	      TweenMax.to(this.$span, 1.2, {
	        x: 0,
	        z: 0,
	        opacity: 1,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SetSpan = __webpack_require__(46);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UIController = function (_Base) {
	  ...
	  function UIController() {
	    ...
	    _this.$target = $('.slider .textWrap .textItem .text');
	    _this.$bar = _this.$target.eq(0).find('.bar');
	    _this.$text = _this.$target.eq(0).find('.textInner .textIn');
	    _this.$arrow = _this.$target.eq(0).find('.arrow svg g path');
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function showFirst() {
	      ...
	      tl
	      // bar
	      .set(this.$bar, { scaleX: 0, scaleY: 0.05, 'transform-origin': '0% 100%' }).to(this.$bar, 1.2, {
	        scaleX: 1,
	        ease: Expo.easeInOut
	      }, 0.0).to(this.$bar, .7, {
	        scaleY: 1.8,
	        ease: Expo.easeIn
	      }, .6).set(this.$bar, { 'transform-origin': '0% 0%', y: '-100%' }).set(this.$text.find('span'), { opacity: 1, x: 0 }).to(this.$bar, .7, {
	        scaleY: 0,
	        ease: Expo.easeOut,
	        onStart: function onStart() {
	          TweenMax.to(_this3.$bar, .7, {
	            opacity: 0,
	            ease: Power2.easeInOut
	          });
	        }
	    ...
	    value: function next() {
	      ...
	      tl.add(function () {
	        ...
	        _this4.hide(_this4.pre);
	      }, 0.0).add(function () {
	
	        _this4.show(_this4.index);
	      }, 0.2);
	    }
	  }, {
	    key: 'onResize',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SetSpan = __webpack_require__(50);
	...
	var UIController = function (_Base) {
	  ...
	  function UIController($target) {
	    ...
	    _this.$target = $target.find('.textInner .textIn');
	    _this.$arrow = $target.find('.arrow svg g path');
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function show() {
	      ...
	      }, 0.0).set(this.$arrow, { drawSVG: "0% 0%" }).to(this.$arrow, 1.2, {
	        drawSVG: "0% 100%",
	        ease: Expo.easeOut
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UIController = function (_Base) {
	  ...
	  function UIController() {
	    ...
	    _this.$target = $('.slider .indicator');
	    _this.$item = _this.$target.find('.item');
	
	    _this.index = 0;
	    _this.pre = 0;
	    _this.len = _this.$item.length;
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function timeline() {
	      ...
	      tl.to(this.$item.find('.bar').eq(this.index), this.dur, {
	        scaleX: 1,
	        ease: Power0.easeNone,
	        onComplete: function onComplete() {
	
	          _this2.pre = _this2.index;
	          _this2.index++;
	          if (_this2.index > _this2.len - 1) {
	            _this2.reset();
	            _this2.index = 0;
	          } else {
	            _this2.timeline();
	          ...
	          $(window).trigger('sliderChange', [_this2.index, _this2.pre]);
	        }
	      });
	    }
	  }, {
	...
	var Controller = function (_Base) {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setup() {
	      ...
	      // canvas
	      gb.canvas = this.c = new _Controller2.default($wrap);
	    }
	  }, {
	    key: 'update',
	    value: function update() {}
	    ...
	    value: function setEvents() {
	      ...
	      $(window).on('sliderChange', function (e, index) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Scene2 = __webpack_require__(57);
	
	var _Scene3 = _interopRequireDefault(_Scene2);
	
	var _Camera2 = __webpack_require__(58);
	
	var _Camera3 = _interopRequireDefault(_Camera2);
	
	var _Light2 = __webpack_require__(59);
	
	var _Light3 = _interopRequireDefault(_Light2);
	
	var _Objects = __webpack_require__(60);
	
	var _Objects2 = _interopRequireDefault(_Objects);
	
	var _Effect = __webpack_require__(75);
	
	var _Effect2 = _interopRequireDefault(_Effect);
	
	var _Control = __webpack_require__(76);
	...
	var Objects = function (_Base) {
	  ...
	  _createClass(Objects, [{
	    ...
	    value: function add() {
	      ...
	      this.Img = new _Controller2.default(this.scene, this.camera);
	    }
	  }, {
	    key: 'update',
	    value: function update() {}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _shader = __webpack_require__(62);
	
	var _shader2 = _interopRequireDefault(_shader);
	
	var _shader3 = __webpack_require__(64);
	
	var _shader4 = _interopRequireDefault(_shader3);
	
	var _shader5 = __webpack_require__(66);
	
	var _shader6 = _interopRequireDefault(_shader5);
	
	var _shader7 = __webpack_require__(67);
	
	var _shader8 = _interopRequireDefault(_shader7);
	
	var _shader9 = __webpack_require__(68);
	
	var _shader10 = _interopRequireDefault(_shader9);
	
	var _shader11 = __webpack_require__(69);
	
	var _shader12 = _interopRequireDefault(_shader11);
	
	var _shader13 = __webpack_require__(70);
	
	var _shader14 = _interopRequireDefault(_shader13);
	
	var _shader15 = __webpack_require__(71);
	
	var _shader16 = _interopRequireDefault(_shader15);
	
	var _shader17 = __webpack_require__(72);
	
	var _shader18 = _interopRequireDefault(_shader17);
	
	var _shader19 = __webpack_require__(73);
	
	var _shader20 = _interopRequireDefault(_shader19);
	
	var _shader21 = __webpack_require__(74);
	
	var _shader22 = _interopRequireDefault(_shader21);
	...
	var Plane = function (_Base) {
	  ...
	  _createClass(Plane, [{
	    ...
	    value: function setup() {
	      ...
	      this.fsIndex = Number(gb.urlp.pattern);
	      log(this.fsIndex);
	      this.fss = [_shader4.default, _shader6.default, _shader8.default, _shader10.default, _shader12.default, _shader14.default, _shader16.default, _shader18.default, _shader20.default, _shader22.default];
	    ...
	    value: function ready() {
	      ...
	      var mat = new THREE.ShaderMaterial({ vertexShader: _shader2.default, fragmentShader: this.fss[this.fsIndex], uniforms: this.uniforms, transparent: true, depthTest: true, side: THREE.DoubleSide });
	      ...
	      var mat = new THREE.ShaderMaterial({ vertexShader: _shader2.default, fragmentShader: this.fss[this.fsIndex], uniforms: this.uniforms2, transparent: true, depthTest: true, side: THREE.DoubleSide });
	    ...
	    value: function show1() {
	      ...
	      TweenMax.to(this.uniforms2.opacity, 3.0, {
	        value: 1.0,
	        ease: Power2.easeOut,
	        delay: 0.1
	      });
	      TweenMax.to(this.uniforms2.dispFactor, 3.0, {
	        value: 1.0,
	        ease: Power2.easeOut,
	        delay: 0.1,
	        onComplete: function onComplete() {
	          ...
	          var next = _this5.index + 1;
	
	          _this5.uniforms2.dispFactor.value = 0;
	          _this5.uniforms2.texture.value = _this5.texList[index];
	          _this5.uniforms2.texture2.value = _this5.texList[next];
	    ...
	    value: function next1() {
	      ...
	      TweenMax.to(this.uniforms2.dispFactor, 3.0, {
	        ...
	        onComplete: function onComplete() {
	          ...
	          var next = _this6.index + 1;
	          var len = _this6.texList.length;
	          if (index == len - 1) {
	            next = 1;
	            _this6.index = 0;
	          }
	
	          _this6.uniforms2.dispFactor.value = 0;
	          _this6.uniforms2.texture.value = _this6.texList[index];
	          _this6.uniforms2.texture2.value = _this6.texList[next];
	          // this.uniforms2.imageResolution.value.x = this.texList[index].image.width;
	          // this.uniforms2.imageResolution.value.x = this.texList[index].image.width;
	    ...
	    value: function show3() {
	      ...
	      TweenMax.to(this.uniforms2.dispFactor, 3.0, {
	        ...
	        onComplete: function onComplete() {
	          ...
	          var index = _this7.index;
	          var next = _this7.index + 1;
	
	          _this7.uniforms2.dispFactor.value = 0;
	          _this7.uniforms2.texture.value = _this7.texList[index];
	          _this7.uniforms2.texture2.value = _this7.texList[next];
	    ...
	    value: function next3() {
	      ...
	      TweenMax.to(this.uniforms2.dispFactor, 3.0, {
	        ...
	        onComplete: function onComplete() {
	          ...
	          var index = _this8.index;
	          var next = _this8.index + 1;
	          var len = _this8.texList.length;
	          if (index == len - 1) {
	            next = 1;
	            _this8.index = 0;
	          }
	
	          _this8.uniforms2.dispFactor.value = 0;
	          _this8.uniforms2.texture.value = _this8.texList[index];
	          _this8.uniforms2.texture2.value = _this8.texList[next];
	          // this.uniforms2.imageResolution.value.x = this.texList[index].image.width;
	          // this.uniforms2.imageResolution.value.x = this.texList[index].image.width;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = "precision highp float;\n#define GLSLIFY 1\n\n" + __webpack_require__(65) + "\n//\n// Description : Array and textureless GLSL 2D/3D/4D simplex\n//               noise functions.\n//      Author : Ian McEwan, Ashima Arts.\n//  Maintainer : ijm\n//     Lastmod : 20110822 (ijm)\n//     License : Copyright (C) 2011 Ashima Arts. All rights reserved.\n//               Distributed under the MIT License. See LICENSE file.\n//               https://github.com/ashima/webgl-noise\n//\n\nvec3 mod289_1_0(vec3 x) {\n  return x - floor(x * (1.0 / 289.0)) * 289.0;\n}\n\nvec4 mod289_1_0(vec4 x) {\n  return x - floor(x * (1.0 / 289.0)) * 289.0;\n}\n\nvec4 permute_1_1(vec4 x) {\n     return mod289_1_0(((x*34.0)+1.0)*x);\n}\n\nvec4 taylorInvSqrt_1_2(vec4 r)\n{\n  return 1.79284291400159 - 0.85373472095314 * r;\n}\n\nfloat snoise_1_3(vec3 v)\n  {\n  const vec2  C = vec2(1.0/6.0, 1.0/3.0) ;\n  const vec4  D_1_4 = vec4(0.0, 0.5, 1.0, 2.0);\n\n// First corner\n  vec3 i  = floor(v + dot(v, C.yyy) );\n  vec3 x0 =   v - i + dot(i, C.xxx) ;\n\n// Other corners\n  vec3 g_1_5 = step(x0.yzx, x0.xyz);\n  vec3 l = 1.0 - g_1_5;\n  vec3 i1 = min( g_1_5.xyz, l.zxy );\n  vec3 i2 = max( g_1_5.xyz, l.zxy );\n\n  //   x0 = x0 - 0.0 + 0.0 * C.xxx;\n  //   x1 = x0 - i1  + 1.0 * C.xxx;\n  //   x2 = x0 - i2  + 2.0 * C.xxx;\n  //   x3 = x0 - 1.0 + 3.0 * C.xxx;\n  vec3 x1 = x0 - i1 + C.xxx;\n  vec3 x2 = x0 - i2 + C.yyy; // 2.0*C.x = 1/3 = C.y\n  vec3 x3 = x0 - D_1_4.yyy;      // -1.0+3.0*C.x = -0.5 = -D.y\n\n// Permutations\n  i = mod289_1_0(i);\n  vec4 p = permute_1_1( permute_1_1( permute_1_1(\n             i.z + vec4(0.0, i1.z, i2.z, 1.0 ))\n           + i.y + vec4(0.0, i1.y, i2.y, 1.0 ))\n           + i.x + vec4(0.0, i1.x, i2.x, 1.0 ));\n\n// Gradients: 7x7 points over a square, mapped onto an octahedron.\n// The ring size 17*17 = 289 is close to a multiple of 49 (49*6 = 294)\n  float n_ = 0.142857142857; // 1.0/7.0\n  vec3  ns = n_ * D_1_4.wyz - D_1_4.xzx;\n\n  vec4 j = p - 49.0 * floor(p * ns.z * ns.z);  //  mod(p,7*7)\n\n  vec4 x_ = floor(j * ns.z);\n  vec4 y_ = floor(j - 7.0 * x_ );    // mod(j,N)\n\n  vec4 x = x_ *ns.x + ns.yyyy;\n  vec4 y = y_ *ns.x + ns.yyyy;\n  vec4 h = 1.0 - abs(x) - abs(y);\n\n  vec4 b0 = vec4( x.xy, y.xy );\n  vec4 b1 = vec4( x.zw, y.zw );\n\n  //vec4 s0 = vec4(lessThan(b0,0.0))*2.0 - 1.0;\n  //vec4 s1 = vec4(lessThan(b1,0.0))*2.0 - 1.0;\n  vec4 s0 = floor(b0)*2.0 + 1.0;\n  vec4 s1 = floor(b1)*2.0 + 1.0;\n  vec4 sh = -step(h, vec4(0.0));\n\n  vec4 a0 = b0.xzyw + s0.xzyw*sh.xxyy ;\n  vec4 a1_1_6 = b1.xzyw + s1.xzyw*sh.zzww ;\n\n  vec3 p0_1_7 = vec3(a0.xy,h.x);\n  vec3 p1 = vec3(a0.zw,h.y);\n  vec3 p2 = vec3(a1_1_6.xy,h.z);\n  vec3 p3 = vec3(a1_1_6.zw,h.w);\n\n//Normalise gradients\n  vec4 norm = taylorInvSqrt_1_2(vec4(dot(p0_1_7,p0_1_7), dot(p1,p1), dot(p2, p2), dot(p3,p3)));\n  p0_1_7 *= norm.x;\n  p1 *= norm.y;\n  p2 *= norm.z;\n  p3 *= norm.w;\n\n// Mix final noise value\n  vec4 m = max(0.6 - vec4(dot(x0,x0), dot(x1,x1), dot(x2,x2), dot(x3,x3)), 0.0);\n  m = m * m;\n  return 42.0 * dot( m*m, vec4( dot(p0_1_7,x0), dot(p1,x1),\n                                dot(p2,x2), dot(p3,x3) ) );\n  }\n\n\n\n\nuniform float opacity;\n\n// uniform sampler2D texture;\nuniform sampler2D texture2;\nuniform sampler2D disp;\nuniform sampler2D brush;\nuniform float dispFactor;\nuniform float threshold;\n\n\n\n// main\nvoid main() {\n\n  // bg full\n  vec2 ratio = vec2(\n      min((resolution.x / resolution.y) / (imageResolution.x / imageResolution.y), 1.0),\n      min((resolution.y / resolution.x) / (imageResolution.y / imageResolution.x), 1.0)\n    );\n  vec2 uv = vec2(\n      vUv.x * ratio.x + (1.0 - ratio.x) * 0.5,\n      vUv.y * ratio.y + (1.0 - ratio.y) * 0.5\n    );\n\n  // texture\n  // vec4 texel1 = texture2D(texture, uv);\n  // vec4 texel2 = texture2D(texture2, uv);\n\n  // 1\n  // float x = dispFactor;\n  // x=smoothstep(.0,1.0,(x*2.0+uv.x-1.0));\n  // vec4 texel1 = texture2D(texture, (uv-.5)*(1.-x)+.5);\n  // vec4 texel2 = texture2D(texture2, (uv-.5)*x+.5);\n  \n  // 2\n  vec2 direction = vec2(-1.0, 1.0);\n  const float smoothness = 0.5;\n  const vec2 center = vec2(0.5, 0.5);  \n\n  vec2 v = normalize(direction);\n  v /= abs(v.x) + abs(v.y);\n  float d = v.x * center.x + v.y * center.y;\n  float m = 1.0 - smoothstep(-smoothness, 0.0, v.x * uv.x + v.y * uv.y - (d - 0.5 + dispFactor * (1.0 + smoothness)));\n\n  vec4 texel1 = texture2D(texture, (uv - 0.5) * (1.0 - m) + 0.5);\n  vec4 texel2 = texture2D(texture2, (uv - 0.5) * m + 0.5);\n  \n  vec4 color = mix(texel1, texel2, m);\n\n  gl_FragColor = color;\n  // gl_FragColor = vec4(vec3(color.rgb), opacity);\n  // gl_FragColor = grayScaleTexel;\n\n\n}"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UIController = function (_Base) {
	  ...
	  function UIController() {
	    ...
	    _this.$arrow = $('.arrowBtm svg g path');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Controller = function (_Base) {
	  ...
	  function Controller() {
	    var $toggle = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $('.toggle_menu');
	    var $open = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : $('.open_menu');
	    var $close = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : $('.close_menu');
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setup() {
	      ...
	      this.b = new _Controller2.default();
	    }
	  }, {
	    key: 'toggle',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Btn_open = __webpack_require__(80);
	
	var _Btn_open2 = _interopRequireDefault(_Btn_open);
	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      // // ui
	      this.b_o = new _Btn_open2.default(this.$open, this.r);
...
/***/ (function(module, exports) {
	...
	var Btn = function () {
	  ...
	  _createClass(Btn, [{
	    ...
	    key: 'show_o',
	    value: function show_o() {
	
	      TweenMax.killTweensOf(this.$bar_o);
	
	      this.$bar_o.each(function (index, el) {
	
	        var tl = new TimelineMax({ delay: index * 0.1 });
	
	        tl.set($(el), { 'transform-origin': '100% 50%' }).to($(el), 0.9, {
	          scaleX: 1.0,
	          z: 0,
	          ease: Expo.easeOut
	        });
	    ...
	    value: function hide_o() {
	      ...
	      this.$bar_o.each(function (index, el) {
	        ...
	        tl.set($(el), { 'transform-origin': '0% 50%' }).to($(el), 0.4, {
	          scaleX: 0.0,
	          z: 0,
	          ease: Expo.easeOut,
	          onComplete: function onComplete() {}
	    ...
	    value: function onEnter() {
	      ...
	      this.$bar_o.each(function (index, el) {
	        ...
	        tl.set($(el), { 'transform-origin': '0% 50%' }).to($(el), 0.4, {
	          ...
	          z: 0,
	          ease: Expo.easeOut
	        }).set($(el), { 'transform-origin': '100% 50%' }).to($(el), 0.5, {
	          scaleX: 1.0,
	          z: 0,
	          ease: Expo.easeOut,
	    ...
	    value: function onEnter_c() {
	      ...
	      this.$bar_c.each(function (index, el) {
	
	        var tl = new TimelineMax({ delay: index * 0.1 });
	
	        var cb = function cb(i) {
	          if (i == 0) _this2.isEnter_c = false;
	        };
	        ...
	        tl.set($(el), { 'transform-origin': '0% 50%' }).to($(el), 0.4, {
	          ...
	          onCompleteParams: [index]
	        }).add(cb.bind(_this2, index), 0.8);
	      });
	    }
	  }, {
	    key: 'onLeave_c',
	    value: function onLeave_c() {
	    ...
	    value: function toClose() {
	      ...
	      .add(function () {
	        ...
	        _this3.$bar_o.each(function (index, el) {
	      ...
	      .add(function () {
	        ...
	        TweenMax.killTweensOf(_this3.$bar_c.eq(1).parent());
	        TweenMax.set(_this3.$bar_c.eq(1).parent(), { rotationZ: -45 });
	
	        tl.set(_this3.$bar_c.eq(0), { 'transform-origin': '100% 50%' }).to(_this3.$bar_c.eq(0), 0.4, {
	          scaleX: 1.0,
	          z: 0,
	          ease: Expo.easeOut
	        }).set(_this3.$bar_c.eq(1), { scaleX: 1.0 }, 0.2).to(_this3.$bar_c.eq(1).parent(), 0.4, {
	          rotationZ: 45,
	          z: 0,
	          ease: Power2.easeOut
	        }, 0.2);
	        ...
	        _this3.isLock = false;
	        _this3.isCloseShow = true;
	      }, 1.0).add(function () {
	
	        _this3.timeline_close();
	      }, 3.0);
	    }
	  }, {
	    key: 'toOpen',
	    value: function toOpen() {
	      ...
	      .add(function () {
	        ...
	        _this4.$bar_c.each(function (index, el) {
	      ...
	      .add(function () {
	        ...
	        _this4.isCloseShow = false;
	        _this4.isLock = false;
	      }, 1.0);
	    }
	  }, {
	    key: 'timeline_close',
	    value: function timeline_close() {
	      var _this5 = this;
	      ...
	      this.Timer = setTimeout(function () {
	        ...
	        _this5.timeline_close();
	      }, 10000);
	    }
	  }, {
	    key: 'timeline_close_stop',
	    value: function timeline_close_stop() {
