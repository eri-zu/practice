...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Controller15 = __webpack_require__(69);
	
	var _Controller16 = _interopRequireDefault(_Controller15);
	
	var _Controller17 = __webpack_require__(70);
	...
	var UIController = function (_Base) {
	  ...
	  function UIController() {
	    ...
	    if (gb.urlp.video == '1') {
	      ...
	      var html = '<video id="video" crossOrigin="anonymous" webkit-playsinline style="display:none;" muted="true">' + '<source src="./assets/resource/video/smoke.mp4" type=\'video/mp4; codecs="avc1.42E01E, mp4a.40.2"\'>' + '</video>';
	    }
	    if (gb.urlp.video == '2') {
	
	      var html = '<video id="video" crossOrigin="anonymous" webkit-playsinline style="display:none;" muted="true">' + '<source src="./assets/resource/video/video1.mp4" type=\'video/mp4; codecs="avc1.42E01E, mp4a.40.2"\'>' + '</video>';
	    }
	    if (gb.urlp.video == '3') {
	
	      var html = '<video id="video" crossOrigin="anonymous" webkit-playsinline style="display:none;" muted="true">' + '<source src="./assets/resource/video/video2.mp4" type=\'video/mp4; codecs="avc1.42E01E, mp4a.40.2"\'>' + '</video>';
	    }
	    if (gb.urlp.video == '4') {
	
	      var html = '<video id="video" crossOrigin="anonymous" webkit-playsinline style="display:none;" muted="true">' + '<source src="./assets/resource/video/video3.mp4" type=\'video/mp4; codecs="avc1.42E01E, mp4a.40.2"\'>' + '</video>';
	    }
	    if (gb.urlp.video == '5') {
	
	      var html = '<video id="video" crossOrigin="anonymous" webkit-playsinline style="display:none;" muted="true">' + '<source src="./assets/resource/video/video4.mp4" type=\'video/mp4; codecs="avc1.42E01E, mp4a.40.2"\'>' + '</video>';
	    }
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      // if (gb.urlp.textpattern=='0') this.tit = new Tit();
	      this.tit = new _Controller6.default();
	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      // // 各spanを取得
	      this.$numList = [];
	      this.$target.find('svg .num').each(function (index, el) {
	
	        var $t = _this2.$target.find('svg .num' + (index + 1));
	        _this2.$numList.push($t);
	      });
	      this.$subList = [];
	      this.$sub = this.$target.find('svg .sub1');
	      this.$target.find('svg .sub').each(function (index, el) {
	
	        var $t = _this2.$target.find('svg .sub' + (index + 1));
	        _this2.$subList.push($t);
	      });
	
	      this.numList = [];
	      for (var i = 0; i < this.$numList.length; i++) {
	        var r = new _Render2.default(this.$numList[i], i);
	        this.numList.push(r);
	      }
	      this.subList = [];
	      for (var i = 0; i < this.$subList.length; i++) {
	        var r = new _Render2.default(this.$subList[i], i);
	        this.subList.push(r);
	      }
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function timeline() {
	      ...
	      tl.to(this.$item.find('.bar').eq(this.index), this.dur, {
	        ...
	        $(window).trigger('sliderChangeSlider', [_this2.index, _this2.pre]);
	      }, this.dur - 1.7);
	    }
	  }, {
	    key: 'reset',
	...
	var Controller = function (_Base) {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setEvents() {
	      ...
	      $(window).on('sliderChangeSlider', function (e, index) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Effect = __webpack_require__(67);
	
	var _Effect2 = _interopRequireDefault(_Effect);
	
	var _Control = __webpack_require__(68);
	...
	var Objects = function (_Base) {
	  ...
	  _createClass(Objects, [{
	    ...
	    value: function add() {
	      ...
	      this.Img = new _Controller2.default(this.scene, this.camera, this.renderer);
	    }
	  }, {
	    key: 'update',
	    value: function update() {}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Scene_PE = __webpack_require__(62);
	...
	var _shader3 = __webpack_require__(65);
	  ...
	  _createClass(Plane, [{
	    ...
	    value: function setup() {
	      ...
	      var onload = function onload() {
	        ...
	        _this2.tex1.magFilter = THREE.LinearFilter;
	        _this2.tex1.minFilter = THREE.LinearFilter;
	        _this2.tex2.magFilter = THREE.LinearFilter;
	        _this2.tex2.minFilter = THREE.LinearFilter;
	        _this2.tex3.magFilter = THREE.LinearFilter;
	        _this2.tex3.minFilter = THREE.LinearFilter;
	        _this2.texList.push(_this2.tex1, _this2.tex2, _this2.tex3);
	    ...
	    value: function show() {
	      ...
	      TweenMax.to(this.uniforms.dispFactor, 5.0, {
	        ...
	        onComplete: function onComplete() {
	          ...
	          _this3.uniforms.dispFactor.value = 0;
	          _this3.uniforms.isFirst.value = 0.0;
	          _this3.uniforms.texture.value = _this3.texList[index];
	          _this3.uniforms.texture2.value = _this3.texList[next];
	    ...
	    value: function next() {
	      ...
	      TweenMax.to(this.uniforms.dispFactor, 3.5, {
	        ...
	        onComplete: function onComplete() {
	          ...
	          _this4.uniforms.dispFactor.value = 0;
	          _this4.uniforms.texture.value = _this4.texList[index];
	          _this4.uniforms.texture2.value = _this4.texList[next];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Btn_open = __webpack_require__(72);
