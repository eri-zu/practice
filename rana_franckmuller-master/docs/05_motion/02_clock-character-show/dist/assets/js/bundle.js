	...
	var ViewCommon = function (_Base) {
	  ...
	  _createClass(ViewCommon, [{
	    ...
	    value: function onLoad() {
	      ...
	      //  ui
	      // ------------------------------------------------------------
	      gb.uic = new _Controller2.default();
	
	      var cnt = 0;
	
	      $(window).on('click', function (event) {
	
	        if (cnt == 0) gb.uic.show();
	        if (cnt == 1) gb.uic.hide();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SetSpan = __webpack_require__(32);
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function update() {
	      ...
	      for (var i = 0; i < this.spanList.length; i++) {
	        ...
	        if (this.isShow) s.updateShow();else s.updateHide();
	      }
