...
/** ===========================================================================
 * 頂点によって構成される各種プリミティブ（ポリゴンやライン）には、画像などに由
 * 来するビットマップを貼り付けることができます。
 * ただし、画像を直接貼り付けるということは厳密にはできません。初期化の手順とし
 * てはまず、一度テクスチャと呼ばれるオブジェクトを生成し、そこに画像を割り当て
 * ます。
 * テクスチャは、シェーダ内でその値を読み出すことができるため、読みだした値（色）
 * をフラグメントシェーダから出力することで、結果的にレンダリング結果を見るとま
 * るで画像が貼り付けられているかのように見えます。
 * テクスチャ座標などの新しい頂点属性も出てきますので覚えることが多いのですが、
 * テクスチャは習得必須と言ってもいいくらい大事な概念になりますので、１つ１つ手
 * 順を確認しつつぜひ使い方を覚えておきましょう。
 * ========================================================================= */
