...
export default class Content extends Base {
  ...
  setup() {
    ...
    this.renderer.shadowMap.type = THREE.PCFShadowMap; // PCF (Percentage-Closer Filtering)アルゴリズムを使用してレンダリング
    this.renderer.outputEncoding = THREE.sRGBEncoding;
    this.renderer.toneMapping = THREE.ACESFilmicToneMapping; // トーンマッピング=画像を綺麗に見せるための手法
