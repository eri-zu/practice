...
export default class Effect extends Base {
  ...
  onParamsChange() {
    ...
    this.RGBShiftPass.uniforms.brightness.value =
      this.p.RGBShiftPass_brightness;
  }
  ...
  onTogglePass() {
    ...
    this.composer.setSize(
      gb.r.w * window.devicePixelRatio,
      gb.r.h * window.devicePixelRatio
    );
    this.composer.addPass(this.renderPass);
  ...
  GUISetting() {
    ...
    f2.add(this.p, "RGBShiftPass_angle", 0.0, Math.PI * 2)
      .step(0.01)
      .listen()
      .onChange(this.onParamsChange.bind(this));
    f2.add(this.p, "RGBShiftPass_amount", 0.0, 1.0)
      .step(0.01)
      .listen()
      .onChange(this.onParamsChange.bind(this));
  }
