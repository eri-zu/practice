...
void main() {
  ...
  float elevation = sin(modelPosition.x * uBigWavesFrequency.x + uTime * uBigWavesSpeed) * 
                    sin(modelPosition.z * uBigWavesFrequency.y + uTime * uBigWavesSpeed) * // z軸にも wave作る 
                    uBigWavesElevation;
  ...
  // 3番目の引数に応じて第一引数と第二引数の値を変える
  // uTime * 0.2 : スピード落とす
  // modelPosition.xz * 3.0 : frequency落とす
  // 0.15 : 高さ落とす
  ...
  // 加える複数のパーリンノイズのfrequencyと波の高さをもっとランダムにする
  ...
  vec4 projectionPosition = projectionMatrix * viewPositon;
