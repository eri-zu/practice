...
export default class Controller {
  ...
  cameraMove(){
    const tl = new TimelineMax();
    tl
    .to(this.setupController.base.camera.position, 2,{
  ...
  render(){
    ...
    //glichをかける
    // if(this.postEffect)this.postEffect.glitch(false)
  }
}
