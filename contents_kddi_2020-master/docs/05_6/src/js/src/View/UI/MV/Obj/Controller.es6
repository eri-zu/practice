...
export default class Controller {
  ...
  setGeometry(base_g = null){
    ...
    geometry.setAttribute('rand_Scale',new THREE.BufferAttribute(new Float32Array(rand_Scale),2))
  ...
  show(){
    ...
    tl
      ...
      // 拡大する
      .to(this.mesh.children[0].material.uniforms.s_time, 2.0,{
        value: 1.0,
