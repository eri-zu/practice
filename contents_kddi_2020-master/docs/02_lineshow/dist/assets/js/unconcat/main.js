	...
	var Rand_Obj = function () {
	  ...
	  _createClass(Rand_Obj, [{
	    ...
	    value: function show() {
	      ...
	      tl.to(this.lines[0].material.uniforms.dashOffset, .2, {
	        value: 1,
	        ease: Power4.easeOut
	        ...
	        value: 2,
	        ease: Power4.easeOut
	      }, .2).to(this.lines[2].material.uniforms.dashOffset, .2, {
	        value: 1,
	        ease: Power4.easeOut
	      }, 0).to(this.lines[2].material.uniforms.dashOffset, .3, {
	        value: 2,
	        ease: Power4.easeOut
	      }, .2)
	      // .add(e=>{
	    ...
	    value: function zoomShow(objs) {
	      ...
	      tl.set(objs.line.material, {
	        ...
	        opacity: 1,
	        ease: Power2.easeInOut
	      }, 1.0).to(objs.fill.scale, .1, {
	        x: 1.01,
	        y: 1.01
	      }, 1.15).to(objs.fill.scale, .1, {
	        x: 1,
	        y: 1
	      }, 1.2);
	    }
