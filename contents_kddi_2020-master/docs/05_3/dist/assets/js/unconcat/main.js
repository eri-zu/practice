...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Controller5 = __webpack_require__(44);
	...
	var Controller = function () {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setup() {
	      ...
	      this.objs = [new _Controller4.default(3), new _Controller4.default(4)];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Controller = function () {
	  function Controller() {
	    ...
	    this.colors = [new THREE.Color(0x3afffe), new THREE.Color(0xff8ea3)];
	    this.setup();
	      ...
	      this.textures.map(function (t, i) {
	        ...
	        var material = new THREE.ShaderMaterial({
	          ...
	          uniforms: {
	            ...
	            is_kangi: { type: 'f', value: i < _this2.kangi_num ? 1.0 : 0.0 },
