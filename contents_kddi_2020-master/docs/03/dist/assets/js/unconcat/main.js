	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setup() {
	      ...
	      this.text = new _Controller8.default(function () {
	        ...
	        _this.setupController.base.scene.add(_this.obj.mesh);
	        _this.setupController.base.scene.add(_this.rand_Obj.mesh);
	        _this.setupController.base.scene.add(_this.text.mesh);
	        _this.timeline();
	      });
