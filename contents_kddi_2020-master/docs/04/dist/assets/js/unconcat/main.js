...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Controller = function () {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function show() {
	      var tl = new TimelineMax();
	      tl.to(this.mesh.material.uniforms.time, 1.5, {
	        value: 1.0,
	        ease: Expo.easeInOut
	      }).to(this.mesh.material.uniforms.s_time, 0.5, {
	        value: 1.0,
	        ease: Expo.easeInOut
	      }, 2.0);
	    ...
	    value: function show2() {
	      var tl = new TimelineMax();
	      tl.to(this.mesh.material.uniforms.s_time, 2.6, {
	        value: 0,
	        ease: Expo.easeInOut
	      }).to(this.mesh.material.uniforms.z_time, 1.5, {
	        value: 1.0,
	        // x:10000,
	        ease: Expo.easeOut
	      }, 1.4).to(this.mesh.material.uniforms.z_time, 1, {
	        value: 10.0,
	        // x:10000,
	        ease: Expo.easeInOut
	      });
	  ...
	  _createClass(Rand_Obj, [{
	    ...
	    value: function setup() {
	      ...
	      for (var i = 0; i < this.NUM; i++) {
	        ...
	        var g = new THREE.CircleBufferGeometry(this.r, this.SEGMENT, Math.PI * 0.5);
	        ...
	        // line.scale.set(1);
	        line.position.set(this.positions[i].x, this.positions[i].y, 0);
	        line.rotation.set(0, 0, this.rotation[i]);
	        this.mesh.add(line);
	      }
	    }
	  }, {
	  ...
	  _createClass(Obj, [{
	    ...
	    value: function show() {
	      ...
	      this.mesh.children.map(function (e, i) {
	        ...
	        }, d).to(e.material.uniforms.time, .75 * 2, {
	          value: 1.0
	        }, d + 0.1).to(e.material.uniforms.threshold, .75, {
	          value: .05,
	          ease: Power4.easeOut
	        }, d + .1).to(e.material.uniforms.threshold, .75, {
	          value: 0,
	          ease: Power4.easeOut
	        }, d + .1 + .75);
	      });
	    ...
	    value: function hide() {
	      ...
	      this.mesh.children.map(function (e, i) {
	        ...
	        tl.set(e.material.uniforms.is_kangi, {
	          value: 1
	        }, 0).to(e.material.uniforms.time, time, {
	          value: 2.0
	        }, 0).to(e.material.uniforms.threshold, time, {
	          value: 1.0,
	          ease: Power4.easeOut
	    ...
	    value: function setPosition(tl) {
	      ...
	      this.mesh.children.map(function (e, i) {
	        if (!p[i]) return;
	        tl.set(e.position, {
	          x: window.g.cameraPosi.x,
	          y: window.g.cameraPosi.y,
	          z: window.g.cameraPosi.z
	        }).set(e.scale, {
	          x: p[i].s,
	          y: p[i].s,
	          z: p[i].s
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function show() {
	      ...
	      tl.set(this.mesh.material.uniforms.is_show, {
	        ...
	        value: 2.0
	      }, 0.1).to(this.mesh.material.uniforms.blocksize, time, {
	        value: 10.0
	      }, 0.1).to(this.mesh.material.uniforms.w, time, {
	        value: 0
	      }, 0.1).to(this.mesh.material.uniforms.threshold, time, {
	        value: 0
	      }, 0.1).add(function (e) {
	        _this2.timeline(0);
	      });
