...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Btn_open = __webpack_require__(32);
	
	var _Btn_open2 = _interopRequireDefault(_Btn_open);
	
	var _Btn_close = __webpack_require__(33);
	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      // // ui
	      this.b_o = new _Btn_open2.default(this.$open);
	      this.b_c = new _Btn_close2.default(this.$close);
	    }
	  }, {
	    key: 'update',
	    value: function update() {}
