...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Effect = __webpack_require__(40);
	
	var _Effect2 = _interopRequireDefault(_Effect);
	
	var _Control = __webpack_require__(41);
	...
	var Objects = function (_Base) {
	  ...
	  _createClass(Objects, [{
	    ...
	    value: function add() {
	      ...
	      // this.Img = new Img(this.scene, this.camera, '/assets/resource/img/bg.jpg');
	  ...
	  _createClass(Plane, [{
	    ...
	    value: function ready() {
	      ...
	      var onLoad = function onLoad() {
	        ...
	        var scale = 1;
	        _this2.mesh.scale.set(scale, scale * rate, 1);
