	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      // ui
	      this.menu = new _Controller2.default($('.menu'));
	      this.logo = new _Controller2.default($('.logo'));
	      this.logo_s = new _Controller2.default($('.logo_s'));
	      this.bg = new _Controller4.default($('.bg'));
	      this.tit = new _Controller2.default($('.tit'));
	      this.text = new _Controller2.default($('.text'));
	      this.imgBox = new _Controller2.default($('.imgBox'));
	      this.scroll = new _Controller2.default($('.scroll'));
	      this.indicator = new _Controller2.default($('.indicator'));
