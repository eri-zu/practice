	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      this.SliderTop = new _Controller2.default();
	    }
	  }, {
	    key: 'update',
	    value: function update() {}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Controller = function (_Base) {
	  ...
	  function Controller() {
	    ...
	    _this.$wrap = $('.sliderTop');
	    _this.$img = _this.$wrap.find('.imgs .img');
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function autoSwitch() {
	      ...
	      if (dir == 'next') this.next();else this.prev();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Render = function (_Base) {
	  ...
	  function Render($wrap, len) {
	    ...
	    _this.$wrap = $wrap;
	    _this.$img = _this.$wrap.find('.imgs .img');
	    _this.$text = _this.$wrap.find('.texts .textItem');
