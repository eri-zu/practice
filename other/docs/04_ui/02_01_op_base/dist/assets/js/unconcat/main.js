	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      // // ui
	      this.menu = new _Controller4.default($('.header .menu'));
	      this.logo = new _Controller4.default($('.header .logo'));
	      this.img = new _Controller4.default($('.slider .imgs .img.active'));
	      this.tit = new _Controller4.default($('.slider .textWrap .textItem.active .tit'));
	      this.subTit = new _Controller4.default($('.slider .textWrap .textItem.active .text'));
	      this.indicator = new _Controller4.default($('.slider .indicator'));
	      this.arrow = new _Controller4.default($('.arrowBtm'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _DotWrap = __webpack_require__(33);
	
	var _DotWrap2 = _interopRequireDefault(_DotWrap);
	
	var _Bar_h = __webpack_require__(38);
	
	var _Bar_h2 = _interopRequireDefault(_Bar_h);
	
	var _Bar_v = __webpack_require__(39);
	
	var _Bar_v2 = _interopRequireDefault(_Bar_v);
	
	var _Bar_h_b = __webpack_require__(40);
	
	var _Bar_h_b2 = _interopRequireDefault(_Bar_h_b);
	
	var _Bar_v_r = __webpack_require__(41);
	
	var _Bar_v_r2 = _interopRequireDefault(_Bar_v_r);
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function show() {
	      ...
	      tl.add(function () {
	        ...
	        new _Bar_h2.default(_this2.$wrap);
	      }, 0.09 * 2).add(function () {
	
	        new _Bar_h_b2.default(_this2.$wrap);
	      }, 0.09 * 2).add(function () {
	
	        new _Bar_v2.default(_this2.$wrap);
	      }, 0.09 * 4).add(function () {
	
	        new _Bar_v_r2.default(_this2.$wrap);
	      }, 0.09 * 4).add(function () {
	
	        new _DotWrap2.default(_this2.$wrap);
	      }, 0.0).add(function () {
	
	        TweenMax.to(_this2.$target, 1.5, {
	          opacity: 1,
	          ease: Power2.easeInOut
	        });
	      }, 0.4);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Dot_h = __webpack_require__(36);
	
	var _Dot_h2 = _interopRequireDefault(_Dot_h);
	
	var _Dot_v = __webpack_require__(37);
	
	var _Dot_v2 = _interopRequireDefault(_Dot_v);
	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      this.$wrap = this.$wrap;
	      this.$wrap_h = this.$wrap.find('.dotWrap_h');
	      this.$wrap_v = this.$wrap.find('.dotWrap_v');
	
	      var margin = 2;
	      var w = 2;
	      var h = 2;
	      var boxw = this.$wrap.width();
	      var boxh = this.$wrap.height();
	      ...
	      for (var i = 0; i < this.$dot_h.length; i++) {
	        var d = new _Dot_h2.default(this.$dot_h.eq(i));
	        this.ds_h.push(d);
	      }
	      this.ds_v = [];
	      for (var i = 0; i < this.$dot_v.length; i++) {
	        var d = new _Dot_v2.default(this.$dot_v.eq(i));
	        this.ds_v.push(d);
	      }
	    ...
	    value: function show() {
	      ...
	      var tl = new TimelineMax();
	      tl.add(function () {
	        var arr = a.randomArr(_this3.len_h);
	        for (var i = 0; i < _this3.len_h; i++) {
	      ...
	      tl02.add(function () {
	        var arr = a.randomArr(_this3.len_v);
	        for (var i = 0; i < _this3.len_v; i++) {
	...
	var Dot = function (_Base) {
	  ...
	  _createClass(Dot, [{
	    ...
	    value: function setEvents() {
	      ...
	      _get(Dot.prototype.__proto__ || Object.getPrototypeOf(Dot.prototype), 'setEvents', this).call(this);
	    }
	  }]);
...
/***/ (function(module, exports) {
	...
	var Bar = function () {
	  function Bar($wrap) {
	    ...
	    this.$wrap = $wrap;
	    this.$target = $wrap.find('.barWrap_h.top');
	  ...
	  _createClass(Bar, [{
	    ...
	    value: function setup() {
	      ...
	      // width back
	      TweenMax.set(this.$target, { x: -this.w / 4 });
	    ...
	    key: 'state_move',
	    value: function state_move() {
	
	      var tl = new TimelineMax({ delay: 0 });
	      tl.to(this.$target, 1.2, {
	        x: this.w / 2,
...
/***/ (function(module, exports) {
	...
	var Bar = function () {
	  function Bar($wrap) {
	    ...
	    this.$wrap = $wrap;
	    this.$target = $wrap.find('.barWrap_v.left');
	    this.$bar = this.$target.find('.bar');
	  ...
	  _createClass(Bar, [{
	    ...
	    value: function setup() {
	      ...
	      // width back
	      TweenMax.set(this.$target, { y: -this.h / 4 });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Dom = function (_Base) {
	  ...
	  _createClass(Dom, [{
	    ...
	    key: 'show',
	    value: function show() {
	      var dur = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1.2;
