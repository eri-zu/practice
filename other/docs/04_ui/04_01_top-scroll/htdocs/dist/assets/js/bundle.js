...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Controller7 = __webpack_require__(45);
	
	var _Controller8 = _interopRequireDefault(_Controller7);
	
	var _Controller9 = __webpack_require__(49);
	  ...
	  _createClass(Dom, [{
	    ...
	    value: function show_detail() {
	      ...
	      tl.add(function () {
	        ...
	        _this3.$img.each(function (index, el) {
	          ...
	          //   delay: 0.2 + index * 0.4,
	          // }, 0.0)
	          _this3.show_text(index, 0.5 + index * 0.4);
	        });
	      }, 0.0);
	    }
	  }, {
	  ...
	  _createClass(Dom, [{
	    ...
	    value: function setup() {
	      ...
	      s01.cb = function () {
	        ...
	        _this2.show_wrap(_this2.$svg01, _this2.$bg01, 0, .4 * 0);
	        _this2.show_wrap(_this2.$svg02, _this2.$bg02, 1, .4 * 1);
	        _this2.show_wrap(_this2.$svg03, _this2.$bg03, 2, .4 * 2);
	        s01.removeEvents();
	      };
	    }
	  }, {
	    ...
	    value: function show_detail() {
	      ...
	      tl.add(function () {
	        ...
	        _this3.$img.each(function (index, el) {
	          ...
	          //   delay: 0.2 + index * 0.2,
	          // }, 0.0)
	          _this3.show_date(index, 0.2 + index * 0.2);
	          _this3.show_text(index, 0.5 + index * 0.2);
	        });
	      }, 0.0).to(this.$btn, 1.2, {
	        opacity: 1,
	        ease: Power1.easeInOut
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SetSpan = __webpack_require__(47);
	  ...
	  _createClass(Dom, [{
	    ...
	    value: function show_detail() {
	      ...
	      tl.add(function () {
	        ...
	        for (var i = 0; i < _this3.textList.length; i++) {
	
	          _this3.show_text(i, 0.5 + i * 0.2);
	        }
	      }, 0.0);
	    }
	  }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SetSpan = __webpack_require__(51);
