	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      tl.add(function () {
	        ...
	        new _Bar_h2.default($('.barWrap_h.top'));
	      }, 0.09 * 0).add(function () {
	
	        new _Bar_h_b2.default($('.barWrap_h.bottom'));
	      }, 0.09 * 1).add(function () {
	
	        new _Bar_v2.default($('.barWrap_v.left'));
	      }, 0.09 * 2).add(function () {
	
	        new _Bar_v_r2.default($('.barWrap_v.right'));
	      }, 0.09 * 3).add(function () {
	
	        new _DotWrap2.default();
	      }, 0.2).add(function () {
	
	        TweenMax.to(_this2.$img, 1.0, {
	          opacity: 1,
	          ease: Power2.easeInOut
	        });
	      }, 0.4);
	...
	var Dot = function (_Base) {
	  ...
	  _createClass(Dot, [{
	    ...
	    value: function show(index) {
	      ...
	      tl.set(this.$target, { opacity: 1.0, delay: 0.01 * index })
	...
	var Dot = function (_Base) {
	  ...
	  _createClass(Dot, [{
	    ...
	    value: function show(index) {
	      ...
	      tl.set(this.$target, { opacity: 1.0, delay: 0.02 * index })
	      // .set(this.$target, {opacity: 0})
	      .to(this.$target, 1.5, {
	        opacity: 0,
	        x: 0,
	...
	var Bar = function () {
	  ...
	  _createClass(Bar, [{
	    ...
	    value: function setup() {
	      ...
	      // width back
	      TweenMax.set(this.$wrap, { x: w - this.w / 4 * 3, rotationZ: 180 });
