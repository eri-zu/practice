...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Controller15 = __webpack_require__(68);
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      if (gb.r.w >= 568) {
	        ...
	        var texList = ['./assets/resource/img/watch/PC_TOP_1.jpg', './assets/resource/img/watch/PC_TOP_2.jpg', './assets/resource/img/watch/PC_TOP_3.jpg'];
	      } else {
	
	        var texList = ['./assets/resource/img/watch/1.jpg', './assets/resource/img/watch/2.jpg', './assets/resource/img/watch/3.jpg'];
	      }
	
	      var cnt = 0;
	      var onload = function onload(tex) {
	
	        tex.magFilter = THREE.LinearFilter;
	        tex.minFilter = THREE.LinearFilter;
	        _this2.texList.push(tex);
	        ...
	        if (cnt <= 2) {
	          ...
	          _this2.logo = new _Controller2.default();
	          _this2.tit = new _Controller6.default();
	          _this2.text = new _Controller10.default();
	          _this2.indicator = new _Controller12.default();
	          _this2.slider = new _Controller14.default();
	          _this2.underArrow = new _Controller16.default();
	          _this2.menu = new _Controller18.default();
	    ...
	    value: function timeline() {
	      ...
	      if (gb.r.w >= 568) {
	        ...
	        tl.add(function () {
	          ...
	          _this3.logo.show();
	        }, 0.0 + .85 + 1.1).add(function () {
	
	          _this3.tit.show();
	        }, 0.8 + .85 - 0.2 + 1.1).add(function () {
	
	          _this3.text.showFirst();
	        }, 0.5 + .85 - 0.2 + 1.1).add(function () {
	
	          _this3.indicator.show();
	          _this3.underArrow.show();
	          _this3.menu.b.b_o.show_o();
	        }, 3.1 + .85 - 1.0 - 0.2 + 1.1).add(function () {
	
	          _this3.indicator.timeline();
	        }, 3.1 + .85 - 1.0 - 0.2 + 1.1);
	      } else {
	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      if (gb.r.w < 568) TweenMax.set(this.$item, { scaleX: 0, 'transform-origin': '100% 50%' });
	    ...
	    value: function timeline() {
	      ...
	      tl.to(this.$item.find('.bar').eq(this.index), this.dur, {
	        ...
	        var pre = _this2.index;
	        var index = _this2.index;
	        index++;
	        if (index > _this2.len - 1) {
	          index = 0;
	        }
	
	        $(window).trigger('sliderChangeSlider', [index, pre]);
	...
	var Controller = function (_Base) {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function show() {
	      ...
	      this.c.scene01.obj.show(0);
	      // this.c.scene01.obj.next(this.index);
	...
	var Content = function (_Base) {
	  ...
	  _createClass(Content, [{
	    ...
	    value: function onResize() {
	      ...
	      var w = gb.$imgWrap.width();
	      var h = gb.$imgWrap.height();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Effect = __webpack_require__(66);
	
	var _Effect2 = _interopRequireDefault(_Effect);
	
	var _Control = __webpack_require__(67);
	...
	var Scene = function (_Base) {
	  ...
	  _createClass(Scene, [{
	    ...
	    value: function onResize() {
	      ...
	      var w = gb.$imgWrap.width() * window.devicePixelRatio;
	      var h = gb.$imgWrap.height() * window.devicePixelRatio;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Camera = function (_Base) {
	  ...
	  function Camera(scene) {
	    ...
	    _this.fov = 45;
	    _this.w = gb.$imgWrap.width();
	    _this.h = gb.$imgWrap.height();
	...
	var Objects = function (_Base) {
	  ...
	  _createClass(Objects, [{
	    ...
	    value: function add() {
	      ...
	      this.imgList = [];
	      this.Img1 = new _Controller2.default(this.scene, this.camera, 1);
	      this.Img2 = new _Controller2.default(this.scene, this.camera, 2);
	      this.Img3 = new _Controller2.default(this.scene, this.camera, 3);
	    ...
	    value: function next(num) {
	      ...
	      tl.add(function () {
	        ...
	        _this3.imgList[num].next(0.7, _this3.imgList.length);
	      }, 0.0).add(function () {
	
	        for (var i = 0; i < _this3.imgList.length; i++) {
	          var img = _this3.imgList[i];
	    ...
	    value: function onResize() {
	      ...
	      for (var i = 0; i < this.imgList.length; i++) {
	        ...
	        if (this.num == i) img.onResize(true);else img.onResize(false);
	      }
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Plane = function (_Base) {
	  ...
	  function Plane(scene, camera, index) {
	  ...
	  _createClass(Plane, [{
	    ...
	    value: function show(delay) {
	      ...
	      .add(function () {
	        ...
	        if (_this2.index !== 0) return;
	
	        TweenMax.to(_this2.p, 1.6, {
	          x1: _this2.w / 2,
	          ease: Expo.easeInOut
	        });
	        TweenMax.to(_this2.p, 1.6, {
	    ...
	    key: 'next',
	    value: function next() {
	      var delay = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.7;
	      ...
	      .set(this, {
	        ...
	        _this3.mesh.position.z = len * 0.01;
	    ...
	    key: 'onResize',
	    value: function onResize(isShow) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Btn_open = __webpack_require__(71);
