...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _LoaderImage = __webpack_require__(27);
	
	var _LoaderImage2 = _interopRequireDefault(_LoaderImage);
	...
	var LoadMgr = function () {
	  ...
	  _createClass(LoadMgr, [{
	    ...
	    value: function setup() {
	      ...
	      this.l = new _LoaderImage2.default();
...
/***/ (function(module, exports) {
	...
	var LoaderImage = function () {
	  function LoaderImage() {
	    _classCallCheck(this, LoaderImage);
	
	    this.list = [];
	    this.cb = function () {};
	  }
	
	  _createClass(LoaderImage, [{
	    key: 'img',
	    ...
	    value: function loadImg() {
	      ...
	      var cb02 = function cb02() {
	        ...
	        for (var i = 0; i < len; i++) {
	          ...
	          var img = _this3.queue.getResult('img' + gb.u.s.add0(i));
	
	          _this3.imgList.push(img);
	        }
	...
	var Scene = function (_Base) {
	  ...
	  _createClass(Scene, [{
	    ...
	    value: function add() {
	      ...
	      // effect
	      this.renderBase = new THREE.WebGLRenderTarget(gb.r.w, gb.r.h);
	      this.e = new _Effect2.default(this.isEffect, this.isGUI, this.renderer, this.scene, this.camera, this.renderBase.texture);
	    ...
	    value: function draw() {
	      ...
	      if (this.e.isEffect) {
	        ...
	        this.renderer.render(this.scene, this.camera, this.renderBase);
	    ...
	    value: function setEvents() {
	      ...
	      _get(Scene.prototype.__proto__ || Object.getPrototypeOf(Scene.prototype), 'setEvents', this).call(this);
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Camera = function (_Base) {
	  ...
	  function Camera(scene) {
	    ...
	    _this.$text = $('.text');
	    _this.w = _this.$text.width();
	    _this.h = _this.$text.height();
	...
	var Objects = function (_Base) {
	  ...
	  _createClass(Objects, [{
	    ...
	    value: function add() {
	      ...
	      this.Plane1 = new _Controller2.default(this.scene, this.camera, './assets/resource/img/watch/PC_TOP_1.jpg');
	      this.Plane2 = new _Controller2.default(this.scene, this.camera, './assets/resource/img/watch/PC_TOP_2.jpg');
	      this.Plane3 = new _Controller2.default(this.scene, this.camera, './assets/resource/img/watch/PC_TOP_3.jpg');
	
	      var tl = new TimelineMax({ delay: 2.0, repeat: -1, repeatDelay: 6.5 - 1.0 });
	
	      tl.add(function () {
	
	        _this2.Plane1.timeline();
	      }, 0.0).add(function () {
	
	        _this2.Plane2.timeline();
	      }, 6.5 - 1.0 * 1).add(function () {
	
	        _this2.Plane3.timeline();
	      }, 6.5 * 2 - 1.0 * 2);
	  ...
	  _createClass(Plane, [{
	    ...
	    value: function setup() {
	      ...
	      var onload = function onload() {
	        ...
	        _this2.texList.push(_this2.tex1);
