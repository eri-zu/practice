...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _UpdateMgr = __webpack_require__(22);
	
	var _UpdateMgr2 = _interopRequireDefault(_UpdateMgr);
	
	var _ResizeMgr = __webpack_require__(23);
	...
	var Render = function () {
	  ...
	  _createClass(Render, [{
	    ...
	    value: function show() {
	      ...
	      this.$target = $('.loading');
	      var $shape = this.$target.find('.shape');
	      ...
	      tll.to(this.$target.find('.inner'), 1.2, {
	        opacity: 1,
	        y: 0,
	        ease: Expo.easeOut
	      })
	      ...
	      .add(function () {
	        ...
	        _this.tl1 = new TimelineMax({ repeat: -1, delay: .7 * 0, repeatDelay: 1.2 });
	        _this.tl2 = new TimelineMax({ repeat: -1, delay: .7 * 1, repeatDelay: 1.2 });
	        _this.tl3 = new TimelineMax({ repeat: -1, delay: .7 * 2, repeatDelay: 1.2 });
	
	        _this.tl1.set($shape.eq(0), { rotation: -180 * 0.15 }).to($shape.eq(0), .6, {
	          scale: 1,
	          opacity: 1,
	          rotation: 0,
	          ease: Expo.easeOut
	        ...
	        _this.tl2.set($shape.eq(1), { rotation: -180 * 0.35 }).to($shape.eq(1), .6, {
	          scale: 1,
	          opacity: 1,
	          rotation: 0,
	          ease: Expo.easeOut
	        ...
	        _this.tl3.set($shape.eq(2), { rotation: -180 * 0.35 }).to($shape.eq(2), .6, {
	          scale: 1,
	          opacity: 1,
	          rotation: 0,
	          ease: Expo.easeOut
	    ...
	    value: function hide() {
	      ...
	      tl.to(this.$target.find('.inner'), 1.2, {
	        opacity: 0,
	        y: -15,
	        ease: Expo.easeOut
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Controller3 = __webpack_require__(31);
	...
	var UAParser = __webpack_require__(51);
	...
	var Controller = function () {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setup() {
	      ...
	      var textspath = gb.conf.BUILT_IN ? "/assets-2020/img/" : './assets/img/';
	      var num = 11;
	      var tp = [];
	      var loader = new _Controller14.default();
	      for (var i = 0; i < num; i++) {
	        var _i = i + 1;
	      ...
	      Promise.all(tp).then(function (textures) {
	        // console.log(textures);
	        _this.text = new _Controller8.default(textures);
	        loader.load(textspath + 'main.png').then(function (texture) {
	          _this.maintext = new _Controller10.default(texture);
	          _this.ready();
	        });
	      });
	    ...
	    value: function show() {
	      ...
	      .add(function (e) {
	        ...
	        _this4.postEffect.glitchShow(.3);
	      ...
	      .add(function (e) {
	        ...
	        _this4.postEffect.glitchShow(.4);
	    ...
	    value: function timeline() {
	      ...
	      // mainText
	      .add(function (e) {
	        _this5.maintext.show(_this5.postEffect);
	        _this5.showContents();
	      }, 0.8 + 0.1)
	      ...
	      // main text
	      .add(function (e) {
	        _this5.maintext.hide(_this5.postEffect);
	      }, 5.9 + 0.0 + 2.0)
	      // loop
	      .add(function (e) {
	        ++_this5.c;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _statsJs = __webpack_require__(30);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _getTriangle = __webpack_require__(35);
	
	var _getTriangle2 = _interopRequireDefault(_getTriangle);
	
	var _getRect = __webpack_require__(36);
	
	var _getRect2 = _interopRequireDefault(_getRect);
	
	var _getHexagon = __webpack_require__(37);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _GetBasePosition = __webpack_require__(39);
	
	var basePosi = _interopRequireWildcard(_GetBasePosition);
	
	var _ShowAnimation = __webpack_require__(40);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _glitch = __webpack_require__(49);
	    ...
	    */
	    ...
	    if (typeof(exports) !== UNDEF_TYPE) {
	        ...
	        */
	        ...
	        if ("function" === FUNC_TYPE && __webpack_require__(52)) {
