	...
	var Controller = function () {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setup() {
	      ...
	      this.obj2 = new _Controller4.default(10, true);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vert_mini = __webpack_require__(41);
	
	var _vert_mini2 = _interopRequireDefault(_vert_mini);
	
	var _Controller = __webpack_require__(42);
	
	var _Controller2 = _interopRequireDefault(_Controller);
	
	var _getGeometry = __webpack_require__(43);
	
	var _getGeometry2 = _interopRequireDefault(_getGeometry);
	
	var _getGeometry_random = __webpack_require__(44);
	
	var _getGeometry_random2 = _interopRequireDefault(_getGeometry_random);
	...
	var Controller = function () {
	  function Controller() {
	    ...
	    var is_random = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	    ...
	    this.Y_NUM = is_random ? window.innerWidth / 300 : Math.floor(window.innerHeight / this.tri_height) + 2;
	    this.X_NUM = is_random ? window.innerWidth / 300 : Math.floor(window.innerWidth / this.naisetsu) * 2 + 10;
	  ...
	  _createClass(Controller, [{
	    key: 'setup',
	    value: function setup() {
	      var param = { r: this.r, segment: this.SEGMENT, ynum: this.Y_NUM, xnum: this.X_NUM, num: this.NUM, tri_height: this.tri_height, naisetsu: this.naisetsu };
	      var geometry = this.is_random ? (0, _getGeometry_random2.default)(param) : (0, _getGeometry2.default)(param);
	      var material = new THREE.ShaderMaterial({
	        vertexShader: this.is_random ? _vert_mini2.default : _vert2.default,
	    ...
	    value: function lineSetup() {
	      this.line = new _Controller2.default(this.NUM);
	    ...
	    value: function show2() {
	      ...
	      tl.to(this.mesh.children[0].material.uniforms.s_time, 2.6, {
	        ...
	        if (!_this.is_random) _this.line.show();
	      }, 3.3);
	    }
	  }, {
	    key: 'show_random',
	    value: function show_random() {
	      var tl = new TimelineMax();
	      tl.to(this.mesh.children[0].material.uniforms.time, 3, {
	        ...
	        value: 1.0,
	        ease: Expo.easeInOut
	      }, 0).to(this.mesh.children[0].material.uniforms.s_time, 1, {
	        value: 0,
	        // x:10000,
	        ease: Expo.easeInOut
	      }, 1.9);
...
/***/ (function(module, exports) {
	...
	exports.default = function (param) {
	  var base_geometry = new THREE.CircleBufferGeometry(param.r, param.segment, Math.PI * 0.5);
	  var base_geometry2 = new THREE.CircleBufferGeometry(param.r, param.segment, Math.PI * 1.5);
	  ...
	  var base_m = -window.innerWidth * 0.5;
	  var base_y = window.innerHeight * 0.5;
	  ...
	  for (var _y = 0; _y < param.ynum; _y++) {
	    var _loop = function _loop() {
	      ...
	      var _margin_y = base_y - _y * param.tri_height;
	      var _d = -param.naisetsu * .5 * (_y % 2);
