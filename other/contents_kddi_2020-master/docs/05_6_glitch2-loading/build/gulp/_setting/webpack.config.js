...
var setting = {
  entry: {
    ...
    loading: PATH.src.js + "src/Loading/Loading.es6"
  ...
  module: {
    loaders: [
      // { test: /\.css$/, loader: "style!css" },
      {
        ...
        include: [path.resolve(PATH.src.js + "src/")],
  ...
  resolve: {
    root: [path.resolve(PATH.src.js + "src/"), path.join(__dirname + "/..", "node_modules")]
  },
  resolveLoader: {
