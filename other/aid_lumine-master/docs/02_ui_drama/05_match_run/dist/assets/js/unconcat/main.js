	...
	var ViewCommon = function (_Base) {
	  ...
	  _createClass(ViewCommon, [{
	    ...
	    value: function onLoad() {
	      ...
	      this.ts = [];
	      $('#matches .itemW').each(function (index, el) {
	        ...
	        var m = new _Controller2.default($(el), $a);
	        _this2.ts.push(m);
	      });
	      ...
	      tl.add(function () {
	        ...
	        for (var i = 0; i < _this2.ts.length; i++) {
	          var m = _this2.ts[i];
	          m.timeline();
	        }
	      }, 2.0).add(function () {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function ready() {
	      ...
	      tl.add(function () {
	        ...
	        _this2.$ashiato.addClass('itemWrapA');
	    ...
	    value: function rotateDirP() {
	      ...
	      tl.add(function () {
	        ...
	        _this5.cntPos++;
	        TweenMax.set(_this5.$wrap, { x: pos.x, y: pos.y });
	    ...
	    value: function rotateDirPGyaku() {
	      ...
	      tl.add(function () {
	        ...
	        log(deg, _this6.rotates, _this6.cntR, _this6.pos, pos);
	    ...
	    value: function rotateDirP_reverse() {
	      ...
	      tl.add(function () {
	        ...
	        l.x -= pos.left;
	        l.y -= pos.top;
	        var obj = { x: l.x + l.width - _this7.defl.width / 2, y: l.y };
	      ...
	      .add(function () {
	        ...
	        l.x -= pos.left;
	        l.y -= pos.top;
	        var obj = { x: l.x + l.width - _this7.defl.width / 2, y: l.y + l.height - _this7.defl.height };
	        TweenMax.set(_this7.$wrap, { x: obj.x, y: obj.y });
	        _this7.pos.push(obj);
