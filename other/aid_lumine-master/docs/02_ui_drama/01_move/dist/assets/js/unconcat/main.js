...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Controller = function (_Base) {
	  ...
	  function Controller() {
	    ...
	    _this.$target = _this.$wrap.find('img');
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function rotate() {
	      ...
	      tl.set(this.$target, { 'transform-origin': '50% 100%' }).set(this.$target, {
	        rotationZ: deg,
	        onComplete: function onComplete() {}
	      }, dur * 0.5)
	      // rotate後の位置を取得
	      .add(function () {
	        ...
	        var l = _this3.$target.get(0).getBoundingClientRect();
	        TweenMax.set(_this3.$wrap, { x: l.x + l.width - _this3.defl.width, y: l.y + l.height - _this3.defl.height });
	      }, dur * 0.5).set(this.$target, { 'transform-origin': '50% 0%' }).set(this.$target, {
	        rotationZ: -deg
	      }, dur)
	      // rotate後の位置を取得
	      .add(function () {
