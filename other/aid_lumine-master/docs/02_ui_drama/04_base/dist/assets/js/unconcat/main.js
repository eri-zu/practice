	  ...
	  _createClass(Controller, [{
	    ...
	    value: function timeline() {
	      ...
	      tl.add(function () {
	        ...
	        if (Math.random() < 0.5) {}
	        // TweenMax.set(this.$W, {rotationZ: '+=' + 180});
	      }, 0.5).add(function () {
	    ...
	    value: function rotateDirP() {
	      ...
	      tl.add(function () {
	        ...
	        TweenMax.set(_this3.$ashiato, { rotationZ: '-=' + .5 });
	
	        // pos
	        var pos = _this3.pos[_this3.pos.length - 1 - _this3.cntPos];
	        _this3.cntPos++;
	        TweenMax.set(_this3.$wrap, { x: pos.x, y: pos.y });
	
	        // origin change
	        TweenMax.set(_this3.$target, { 'transform-origin': '50% 0%' });
	      }, dur * 0.5)
	      ...
	      .add(function () {
	        ...
	        // origin change
	        TweenMax.set(_this3.$target, { 'transform-origin': '50% 100%' });
	
	        // end
	        if (_this3.maxcnt < _this3.cntR) {
	          TweenMax.set(_this3.$target, { rotationZ: 0 });
	          return;
	        }
	      }, dur)
	    ...
	    value: function rotateDirP_reverse() {
	      ...
	      tl.add(function () {
	        ...
	        // pos
	        var l = _this4.$target.get(0).getBoundingClientRect();
	        var pos = _this4.$wrapW.get(0).getBoundingClientRect();
	        l.x -= pos.left;
	        l.y -= pos.top;
	        var obj = { x: l.x + l.width - _this4.defl.width / 2, y: l.y };
	        TweenMax.set(_this4.$wrap, { x: obj.x, y: obj.y });
	        _this4.pos.push(obj);
	      ...
	      .add(function () {
	        ...
	        l.x -= pos.left;
	        l.y -= pos.top;
	        var obj = { x: l.x + l.width - _this4.defl.width / 2, y: l.y + l.height - _this4.defl.height };
	        TweenMax.set(_this4.$wrap, { x: obj.x, y: obj.y });
	        _this4.pos.push(obj);
