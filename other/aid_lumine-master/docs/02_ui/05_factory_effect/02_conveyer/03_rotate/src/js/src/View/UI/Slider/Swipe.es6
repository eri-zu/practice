...
export default class Swipe {
  ...
  setEvents(){
    ...
    this.$wrap.on('touchstart.SwipeTop', (e)=>{this.onTouchStart(e);});
    this.$wrap.on('touchmove.SwipeTop', (e)=>{this.onTouchMove(e);});
    $(window).on('touchend.SwipeTop', (e)=>{this.onTouchEnd(e);});
