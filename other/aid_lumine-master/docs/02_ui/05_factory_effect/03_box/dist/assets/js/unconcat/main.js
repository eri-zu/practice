	...
	var UIController = function (_Base) {
	  ...
	  _createClass(UIController, [{
	    ...
	    value: function setup() {
	      ...
	      var arr = a.randomArr(this.len);
	      this.$itemp.each(function (index, el) {
	
	        // if (index>0) return;
	
	        // var $t = this.$item.eq(this.len - index);
	        var $t = _this2.$itemp.eq(index);
	    ...
	    value: function lane1_moveX() {
	      ...
	      this.tl.to(this.$target, this.dur, {
	        ...
	        onStart: function onStart() {
	          ...
	          if (_this3.isFirst) var cnt = 10 + _this3.index * _this3.sa;else var cnt = 10 + _this3.lastIndex * _this3.sa;
	
	          if (_this3.cnt == cnt - 3) {
	
	            TweenMax.to(_this3.$target, _this3.dur * 0.2, {
	              scale: 0,
	              ease: Back.easeIn
	            });
	          }
	        ...
	        onComplete: function onComplete() {
	          ...
	          if (_this3.cnt == cnt - 2) {
	            ...
	            TweenMax.to(_this3.$target, _this3.dur, {
	              x: '+=' + 100 * _this3.rate,
	              ease: Elastic.easeOut.config(1, 1.0)
	            });
	
	            TweenMax.set(_this3.$target, { x: _this3.leftEnd, y: 0, scale: 1 });
	    ...
	    value: function lane2_moveX() {
	      ...
	      this.tl.to(this.$target, this.dur, {
	        ...
	        onStart: function onStart() {
	          ...
	          if (_this4.isFirst) var cnt = 8 + _this4.index * _this4.saPre;else var cnt = 0 + _this4.lastIndexPre * _this4.saPre;
	
	          if (_this4.cnt == cnt) {
	
	            TweenMax.to(_this4.$target.find('img'), _this4.dur * 0.6, {
	              scale: 1,
	        ...
	        onComplete: function onComplete() {
	          ...
	          if (_this4.isFirst) var cnt = 18 + _this4.index * _this4.saPre;else var cnt = 10 + _this4.lastIndexPre * _this4.saPre;
	
	          if (_this4.cnt == cnt) {
	            _this4.cnt = 0;
	            _this4.isFirst = false;
	
	            TweenMax.set(_this4.$target, { x: _this4.leftEndPre * _this4.rate, y: 0 });
	            TweenMax.set(_this4.$target.find('img'), { scale: 0.0 });
