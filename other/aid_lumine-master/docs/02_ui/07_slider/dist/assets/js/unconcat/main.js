...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Controller3 = __webpack_require__(34);
	
	var _Controller4 = _interopRequireDefault(_Controller3);
	
	var _Controller5 = __webpack_require__(35);
	...
	var ViewCommon = function (_Base) {
	  ...
	  _createClass(ViewCommon, [{
	    ...
	    value: function onLoad() {
	      ...
	      // new MV();
	      // new Drag();
	      new _Controller4.default($('.imgs'));
	      new _Controller6.default();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Swipe = __webpack_require__(39);
	
	var _Swipe2 = _interopRequireDefault(_Swipe);
	
	var _MouseDrag = __webpack_require__(40);
	...
	var Controller = function (_Base) {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setEvents() {
	      ...
	      if (gb.r.w < 769) this.s = new _Swipe2.default(this.$wrap);else this.s = new _MouseDrag2.default(this.$wrap);
	      ...
	      this.s.onMove = function (sign, val, distance) {
	        ...
	        if (!_this2.isDrag || Math.abs(distance) < gb.r.w / 4 * 1.5) return;
