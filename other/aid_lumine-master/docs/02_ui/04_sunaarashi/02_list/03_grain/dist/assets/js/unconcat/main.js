	  ...
	  _createClass(Plane, [{
	    ...
	    value: function ready() {
	      ...
	      var onLoad = function onLoad() {
	        ...
	        var geo = new THREE.PlaneGeometry(_this2.texture.image.width / 2, _this2.texture.image.height / 2, 10, 10);
