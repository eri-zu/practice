...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Param = __webpack_require__(39);
	...
	var Objects = function (_Base) {
	  ...
	  _createClass(Objects, [{
	    ...
	    value: function add() {
	      ...
	      this.Cube = new _Cube2.default(this.scene, this.camera, this.renderer);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dat = __webpack_require__(40);
	...
	var Param = function (_Base) {
	  _inherits(Param, _Base);
	  ...
	  function Param() {
	    ...
	    _this.color1 = "#ffae23"; // CSS string
	    _this.color2 = [0, 128, 255]; // RGB array
	    _this.color3 = [0, 128, 255, 0.3]; // RGB with alpha
	    _this.color4 = { h: 350, s: 0.9, v: 0.3 }; // Hue, saturation, value    
	  ...
	  _createClass(Param, [{
	    ...
	    key: 'onPresetsChange',
	    value: function onPresetsChange() {
