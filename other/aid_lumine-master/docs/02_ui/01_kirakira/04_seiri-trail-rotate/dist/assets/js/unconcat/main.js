...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Easing = __webpack_require__(47);
	...
	var Objects = function (_Base) {
	  ...
	  _createClass(Objects, [{
	    ...
	    key: 'makeTrail',
	    value: function makeTrail(type, position) {
	      ...
	      TweenLite.to(obj, 0.5, { scale: scale, ease: Back.easeOut, delay: Math.random() * 0.5, onComplete: function onComplete() {
	          obj.startTime = new Date().getTime();
	          obj.isReady = true;
	        } });
	    ...
	    value: function onMouseDown() {
	      ...
	      if (!this.isDown) {
	        ...
	        for (var i = 0; i < 20; i++) {
	          this.makeTrail(null, this.mousePoint);
	        }
	      }
	      this.isDown = true;
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Motion = __webpack_require__(40);
	...
	var _shader3 = __webpack_require__(43);
