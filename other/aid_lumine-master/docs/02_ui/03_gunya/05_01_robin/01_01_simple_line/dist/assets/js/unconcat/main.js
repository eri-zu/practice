...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Effect = __webpack_require__(43);
	...
	var Objects = function (_Base) {
	  ...
	  _createClass(Objects, [{
	    ...
	    value: function add() {
	      ...
	      this.Img = new _Controller2.default(this.scene, this.camera, './assets/resource/img/hero.jpg');
