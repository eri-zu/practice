	...
	var Controller = function (_Base) {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setup() {
	      ...
	      this.ha = new _Controller2.default();
	      ...
	      gb.mv = new _Controller22.default();
	    ...
	    value: function timeline() {
	      ...
	      .add(function () {
	        ...
	        // happy
	        for (var i = 0; i < _this2.$titfront_h.length; i++) {
	
	          var $f = _this2.$titfront_h.eq(i);
	          var $b = _this2.$titbg_h.eq(i);
	          var $t = $f.add($b);
	          var delay = i * 0.07;
	
	          var cb = function cb($t, $f, $b, delay, index) {
	        ...
	        // lumine
	        for (var i = 0; i < _this2.$titfront_l.length; i++) {
	
	          var $f = _this2.$titfront_l.eq(i);
	          var $b = _this2.$titbg_l.eq(i);
	          var $t = $f.add($b);
