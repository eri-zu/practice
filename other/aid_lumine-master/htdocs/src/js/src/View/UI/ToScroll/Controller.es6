...
export default class Controller {
  ...
  setup() {
    ...
    var s01 = new Scroll(targetST, true, ()=>{}, ()=>{}, 'toScroll');
    s01.cb = ()=>{
  ...
  setEvents () {
    ...
    this.$target.find('.hover').on('mouseenter touchstart', function(){self.onEnter.call(self,this)});
    this.$target.find('.hover').on('mouseleave touchend', function(){self.onLeave.call(self,this)});
