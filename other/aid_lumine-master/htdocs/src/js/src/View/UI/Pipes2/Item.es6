...
export default class UIController extends Base {
  ...
  setup() {
    ...
    this.lastIndex = 0;
    this.lastIndexPre = 3;
    this.left = -120 - (80 * this.sa) * this.index;
    this.leftPre = -900 + 35 - (100 * this.saPre) * this.index;
    // this.left = -60 + 200 * this.index;
    this.leftEnd = -120 - (80 * (this.sa)) * this.lastIndex;
    this.leftEndPre = 0 + 35 - (100 * (this.saPre)) * this.lastIndexPre;
    ...
    this.tl
      .to(this.$target, this.dur, {
        ...
        onStart: ()=>{
          ...
          if (this.isFirst) var cnt = 12 + this.index * this.sa;
          else var cnt = 12 + this.lastIndex * this.sa;
    ...
    this.tl
      .to(this.$target, this.dur, {
        ...
        onStart: ()=>{
          ...
          if (this.isFirst) var cnt = 9 + this.index * this.saPre;
        ...
        onComplete: ()=>{
          ...
          if (this.isFirst) var cnt = 19 + this.index * this.saPre;
